      ...
      <Widget>
        ...
        <>
          {isFetching ? (
            ...
            <PrintSingleTcc addAss1={addAss1} addAss2={addAss2} addAss3={addAss3} tccUploads={tccUploads} tccID={tccID} payerDetails={tccdata} assessmentData={assess1} assessmentData2={assess2} assessmentData3={assess3} />
          }
        </>
      </Widget>
    </>
